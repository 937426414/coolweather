...
public class WeatherActivity extends AppCompatActivity {
    ...
    private TextView titleCity,titleUpdateTime,
            degreeText,weatherInfoText,aqiText,
            pm25Text,comfortText,carwasgText,
            sportText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        carwasgText = (TextView) findViewById(R.id.car_wash_text);
    ...
    private void requestWeather(String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid="+ weatherId +"&key=144ccd70e8364fc4acc2c0ec6ceade52";
